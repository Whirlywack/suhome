...
- [x] Configure build and development environment (AC: 4, 5)
  - [x] Set up Next.js configuration for static site generation optimization
...
- `tsconfig.json` - TypeScript configuration
- `next.config.js` - Next.js static site generation config
...
- Performance optimization (static site generation, font display: swap)
