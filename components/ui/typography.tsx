...
export const Heading = React.forwardRef<
  HTMLHeadingElement,
  HeadingProps
>(({ children, className, variant = 'h1', as: Component = 'h1', ...props }, ref) => {
  return (
    <Component
      ref={ref}
      className={cn(
        ...
        // Variant styles - beautiful visual hierarchy
        {
          ...
          'text-4xl font-bold leading-tight': variant === 'h1',
          'text-3xl font-semibold leading-tight': variant === 'h2',
          'text-2xl font-semibold leading-tight': variant === 'h3',
          'text-xl font-medium leading-tight': variant === 'h4',
        },
        className
      )}
      {...props}
...
export const Text = React.forwardRef<
  HTMLElement,
  TextProps
>(({ children, className, variant = 'body', as: Component = 'p', ...props }, ref) => {
  return (
    <Component
