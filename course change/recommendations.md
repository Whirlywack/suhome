...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        {/* Before-paint theme init – replace with nonce/hash in CSP when ready */}
...
export default function HomePage() {
  return (
    <main id="main">
      <Hero />
      {/* One-pager sections (also present as standalone pages) */}
      <AboutStory id="about" />
...
/* app/globals.css – add to your existing design tokens */
:root { --nav-h: 56px; }
